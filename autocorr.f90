program main
   ...
   integer,parameter :: ncor = n/2
   real(8),dimension(n) :: Ek, Ep
   real(8),dimension(0:ncor) :: Ek_acf, Ep_acf
   real(8),dimension(0:ncor) :: Ek_cor_avg, Ep_cor_avg
   real(8),dimension(nsample) :: Ek_avg, Ep_avg
   real(8) :: Ek2_avg, Ep2_avg, Ek2_sum,Ep2_sum
...
!	Ek_cor_avg(i)=Ek_cor_avg(i-1)+Ek_cor_avg(i)
      write(12, '(I8,F16.8,1x,E16.8)') i, Ek_cor_avg(i)/Ek_cor_avg(0), Ep_cor_avg(i)/Ep_cor_avg(0)
   end do
